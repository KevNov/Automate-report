...
def execute(message, channel, file_bytes, file=None, file_type=None, title=None):
    token = 'xoxb-4577024717830-4581571402149-sAtrSfPNgr1uSXxWg1SMsATr'
...
if __name__ == '__main__':
    execute('test', '#automate_report', 'C:\\Users\\kevnov\\Documents\\Digital Skola\\automate_report\\output\\sales_per_month.png', file=None, file_type=None, title=None)